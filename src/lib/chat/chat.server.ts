...
import type { ChatRequest, ChatResponse, VideoContext } from "#/features/chat/chat.types";
...
export async function sendChatMessage(request: ChatRequest): Promise<ChatResponse> {
  ...
  if (!response.ok) {
    ...
    console.error("[chat.server] Anthropic API error:", response.status, errorText);
